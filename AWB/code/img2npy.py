...
from AWB.code.core.utils import normalize, linear_to_nonlinear, bgr_to_rgb, correct
...
def main():
    ...
    for img_metadata in tqdm(open(PATH_TO_CC_METADATA, 'r').readlines(), desc="Preprocessing images"):
        ...
        #np.save(os.path.join(PATH_TO_NUMPY_DATA, file_name), Image.fromarray(img_without_mcc))

...
ai_awb_img = ai_awb(demos_img)
plt.imshow(ai_awb_img)
plt.title("ai_awb_img1")
plt.show()

ai_awb_img = ai_awb(demos_img)
plt.imshow(ai_awb_img)
plt.title("ai_awb_img2")
plt.show()

ai_awb_img = ai_awb(demos_img)
plt.imshow(ai_awb_img)
plt.title("ai_awb_img3")
plt.show()

ai_awb_img = ai_awb(demos_img)
plt.imshow(ai_awb_img)
plt.title("ai_awb_img4")
plt.show()
# 10 Color correction matrix
ccm = CCM(awb_img, sensor_info, parm_ccm)
ccm_img = ccm.execute()
ai_ccm = CCM(ai_awb_img, sensor_info, parm_ccm)
ai_ccm_img = ai_ccm.execute()

#  Gamma
gc = GC(ccm_img, sensor_info, parm_gmc)
gamma_raw = gc.execute()
plt.imshow(gamma_raw)
plt.title("gamma_raw")
plt.show()

ai_gc = GC(ai_ccm_img, sensor_info, parm_gmc)
ai_gamma_raw = ai_gc.execute()
plt.imshow(ai_gamma_raw)
plt.title("ai_gamma_raw")
plt.show()
# Auto-Exposure

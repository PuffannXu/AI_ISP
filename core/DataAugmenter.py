...
from AWB.code.core.settings import TRAIN_IMG_H, TRAIN_IMG_W, TEST_IMG_H, TEST_IMG_W
from AWB.code.core.utils import rgb_to_bgr
...
class DataAugmenter:
    ...
    def crop(self, img: np.ndarray, scale: float = 1) -> np.ndarray:
